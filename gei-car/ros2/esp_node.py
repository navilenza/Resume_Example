...
Based on the slow dynamic of the geicar, a control based on a proportional with a feedback is enough and don't introduce instability. If the car dynamic was faster, the proportional would have introduce instability and an integral would be needed.
